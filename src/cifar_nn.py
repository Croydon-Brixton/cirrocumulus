...
class Net(nn.Module):
    def __init__(self):
        ...
        for i in range(len(kernel_size)):
            ...
            self.out = calc_out(
                self.out, stride[i], padding, kernel_size[i], pool_stride[i]
            )
...
train_loader = torch.utils.data.DataLoader(
    train_X, batch_size=batch_size, sampler=train_sampler, num_workers=num_workers
)
valid_loader = torch.utils.data.DataLoader(
    train_X, batch_size=batch_size, sampler=valid_sampler, num_workers=num_workers
)
